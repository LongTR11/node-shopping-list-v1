...
Recipes.create('sloppy joe', ['buns', 'hamburger', 'ketchup', 'mustard']);
Recipes.create('lasagna', ['pasta', 'sauce', 'cheese']);
Recipes.create('ribeye', ['ribeye', 'italian dressing', 'vinegar', 'potato']);
